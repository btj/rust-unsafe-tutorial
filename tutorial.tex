...
\lstset{moredelim=**[s][\itshape]{/*}{*/},moredelim=**[l][\itshape]{//},morekeywords={req,ens,true,false,pred,lem,fix,pred_ctor,leak,open,close,bool,inv,inductive,assert,pred_fam,pred_fam_inst}}
